Veewee::Session.declare({
  ...
  :iso_file => "CentOS-6.2-x86_64-netinstall.iso", :iso_src => "http://mirror.internode.on.net/pub/centos/6.2/isos/x86_64/CentOS-6.2-x86_64-netinstall.iso", :iso_md5 => "20dac370a6e08ded2701e4104855bc6e", :iso_download_timeout => 1000,
